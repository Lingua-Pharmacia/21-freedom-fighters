...
// PERSISTENCE (Specific to Freedom Fighters)
let lifetimeScore = parseInt(localStorage.getItem('freedomFightersScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedFreedomLessons')) || [];
...
// STATIONS 
const stations = [
    {file:"01_AlijaIzetbegovic.mp3", title:"Alija Izetbegović"},
    {file:"02_AmilcarCabral.mp3", title:"Amílcar Cabral"},
    {file:"03_AngelaDavis.mp3", title:"Angela Davis"},
    {file:"04_AssataShakur.mp3", title:"Assata Shakur"},
    {file:"05_BhagatSingh.mp3", title:"Bhagat Singh"},
    {file:"06_BobbySands.mp3", title:"Bobby Sands"},
    {file:"07_CheGuevara.mp3", title:"Che Guevara"},
    {file:"08_DenizGezmis.mp3", title:"Deniz Gezmiş"},
    {file:"09_DjamilaBouhired.mp3", title:"Djamila Bouhired"},
    {file:"10_FrantzFanon.mp3", title:"Frantz Fanon"},
    {file:"11_FredHampton.mp3", title:"Fred Hampton"},
    {file:"12_HoChiMinh.mp3", title:"Ho Chi Minh"},
    {file:"13_MalcolmX.mp3", title:"Malcolm X"},
    {file:"14_NelsonMandela.mp3", title:"Nelson Mandela"},
    {file:"15_OmarMukhtar.mp3", title:"Omar Mukhtar"},
    {file:"16_PatriceLumumba.mp3", title:"Patrice Lumumba"},
    {file:"17_RosaParks.mp3", title:"Rosa Parks"},
    {file:"18_SamoraMachel.mp3", title:"Samora Machel"},
    {file:"19_SteveBiko.mp3", title:"Steve Biko"},
    {file:"20_ThomasSankara.mp3", title:"Thomas Sankara"},
    {file:"21_YasserArafat.mp3", title:"Yasser Arafat"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('freedomFightersScore', lifetimeScore);
    const fn = audio.src.split('/').pop();
    if(!completedLessons.includes(fn)) {
        completedLessons.push(fn); localStorage.setItem('completedFreedomLessons', JSON.stringify(completedLessons));
    }
